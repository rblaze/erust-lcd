//! Sitronix ST7036 display controller driver.
//! Supports basic LCD commands and a few additional ones.
//! Datasheet: https://newhavendisplay.com/content/app_notes/ST7036.pdf
...
mod tests {
    ...
    #[test]
    fn init_sequence_valid() {
        assert_eq!(INIT_SEQUENCE.len(), 3);
        assert_eq!(INIT_SEQUENCE[0], [0x38]);
        assert_eq!(INIT_SEQUENCE[1], [0x39]);
        assert_eq!(INIT_SEQUENCE[2], [0x14, 0x78, 0x5e, 0x6d, 0x0c, 0x01, 0x06]);
    }
}
